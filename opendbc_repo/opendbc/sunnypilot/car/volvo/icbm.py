    ...
    if self.ICBM.sendButton != SendButtonState.none:
      if (self.frame - self.last_button_frame) * DT_CTRL > 0.2:
        if self.ICBM.sendButton == SendButtonState.increase:
          can_sends.append(volvocan.create_button_msg(packer, set_plus=True))
        elif self.ICBM.sendButton == SendButtonState.decrease:
          can_sends.append(volvocan.create_button_msg(packer, minus=True))
